...
namespace FlexibleCouponsVendor\Psr\Log\Test;

use FlexibleCouponsVendor\Psr\Log\LoggerInterface;
use FlexibleCouponsVendor\Psr\Log\LogLevel;
use FlexibleCouponsVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('FlexibleCouponsVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('FlexibleCouponsVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('FlexibleCouponsVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
