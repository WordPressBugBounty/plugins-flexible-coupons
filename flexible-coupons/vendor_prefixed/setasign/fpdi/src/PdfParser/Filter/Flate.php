 ...
 */
class Flate implements \FlexibleCouponsVendor\setasign\Fpdi\PdfParser\Filter\FilterInterface
{
    /**
    ...
    public function decode($data)
    {
        if ($this->extensionLoaded()) {
            ...
            if ($data === \false) {
                ...
                if ($data === \false) {
                    throw new \FlexibleCouponsVendor\setasign\Fpdi\PdfParser\Filter\FlateException('Error while decompressing stream.', \FlexibleCouponsVendor\setasign\Fpdi\PdfParser\Filter\FlateException::DECOMPRESS_ERROR);
                }
            }
        } else {
            throw new \FlexibleCouponsVendor\setasign\Fpdi\PdfParser\Filter\FlateException('To handle FlateDecode filter, enable zlib support in PHP.', \FlexibleCouponsVendor\setasign\Fpdi\PdfParser\Filter\FlateException::NO_ZLIB);
        }
        return $data;
    }
}
