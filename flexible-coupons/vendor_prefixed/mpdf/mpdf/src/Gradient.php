...
class Gradient
{
     ...
     */
    private $writer;
    public function __construct(\FlexibleCouponsVendor\Mpdf\Mpdf $mpdf, \FlexibleCouponsVendor\Mpdf\SizeConverter $sizeConverter, \FlexibleCouponsVendor\Mpdf\Color\ColorConverter $colorConverter, \FlexibleCouponsVendor\Mpdf\Writer\BaseWriter $writer)
    {
        $this->mpdf = $mpdf;
    ...
    {
        $s = ' q ';
        $s .= \sprintf(' %.3F %.3F %.3F %.3F re W n ', $x * \FlexibleCouponsVendor\Mpdf\Mpdf::SCALE, ($this->mpdf->h - $y) * \FlexibleCouponsVendor\Mpdf\Mpdf::SCALE, $w * \FlexibleCouponsVendor\Mpdf\Mpdf::SCALE, -$h * \FlexibleCouponsVendor\Mpdf\Mpdf::SCALE);
        $s .= \sprintf(' %.3F 0 0 %.3F %.3F %.3F cm ', $w * \FlexibleCouponsVendor\Mpdf\Mpdf::SCALE, $h * \FlexibleCouponsVendor\Mpdf\Mpdf::SCALE, $x * \FlexibleCouponsVendor\Mpdf\Mpdf::SCALE, ($this->mpdf->h - ($y + $h)) * \FlexibleCouponsVendor\Mpdf\Mpdf::SCALE);
    ...
    public function Gradient($x, $y, $w, $h, $type, $stops = [], $colorspace = 'RGB', $coords = '', $extend = '', $return = \false, $is_mask = \false)
    {
        ...
        $s = ' q';
        $s .= \sprintf(' %.3F %.3F %.3F %.3F re W n', $x * \FlexibleCouponsVendor\Mpdf\Mpdf::SCALE, ($this->mpdf->h - $y) * \FlexibleCouponsVendor\Mpdf\Mpdf::SCALE, $w * \FlexibleCouponsVendor\Mpdf\Mpdf::SCALE, -$h * \FlexibleCouponsVendor\Mpdf\Mpdf::SCALE) . "\n";
        $s .= \sprintf(' %.3F 0 0 %.3F %.3F %.3F cm', $usew * \FlexibleCouponsVendor\Mpdf\Mpdf::SCALE, $useh * \FlexibleCouponsVendor\Mpdf\Mpdf::SCALE, $usex * \FlexibleCouponsVendor\Mpdf\Mpdf::SCALE, ($this->mpdf->h - ($usey + $useh)) * \FlexibleCouponsVendor\Mpdf\Mpdf::SCALE) . "\n";
        $n = \count($this->mpdf->gradients) + 1;
