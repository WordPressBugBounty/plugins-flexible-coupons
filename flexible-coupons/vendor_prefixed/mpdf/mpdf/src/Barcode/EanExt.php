 ...
 */
class EanExt extends \FlexibleCouponsVendor\Mpdf\Barcode\AbstractBarcode implements \FlexibleCouponsVendor\Mpdf\Barcode\BarcodeInterface
{
    /**
     * @param string $code
     * @param int $length
    ...
    private function init($code, $length = 5)
    {
        ...
        if ($length == 2) {
            ...
            throw new \FlexibleCouponsVendor\Mpdf\Barcode\BarcodeException(sprintf('Invalid EAN barcode value "%s"', $code));
        }
