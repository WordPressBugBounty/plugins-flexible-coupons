 ...
 */
class IntrospectionProcessor implements \FlexibleCouponsVendor\Monolog\Processor\ProcessorInterface
{
    /** @var int */
    private $level;
    /** @var string[] */
     ...
     */
    public function __construct($level = \FlexibleCouponsVendor\Monolog\Logger::DEBUG, array $skipClassesPartials = [], int $skipStackFramesCount = 0)
    {
        $this->level = \FlexibleCouponsVendor\Monolog\Logger::toMonologLevel($level);
