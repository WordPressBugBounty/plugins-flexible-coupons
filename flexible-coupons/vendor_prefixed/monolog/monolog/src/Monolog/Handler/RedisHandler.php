 ...
 */
class RedisHandler extends \FlexibleCouponsVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($redis, string $key, $level = \FlexibleCouponsVendor\Monolog\Logger::DEBUG, bool $bubble = \true, int $capSize = 0)
    {
