...
use FlexibleCouponsVendor\Monolog\Formatter\ChromePHPFormatter;
 ...
 */
class ChromePHPHandler extends \FlexibleCouponsVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \FlexibleCouponsVendor\Monolog\Formatter\ChromePHPFormatter();
    }
    /**
    ...
    protected function send() : void
    {
        ...
        $json = \FlexibleCouponsVendor\Monolog\Utils::jsonEncode(self::$json, \FlexibleCouponsVendor\Monolog\Utils::DEFAULT_JSON_FLAGS & ~\JSON_UNESCAPED_UNICODE, \true);
        $data = \base64_encode($json);
        if (\strlen($data) > 3 * 1024) {
            self::$overflowed = \true;
            $record = ['message' => 'Incomplete logs, chrome header size limit reached', 'context' => [], 'level' => \FlexibleCouponsVendor\Monolog\Logger::WARNING, 'level_name' => \FlexibleCouponsVendor\Monolog\Logger::getLevelName(\FlexibleCouponsVendor\Monolog\Logger::WARNING), 'channel' => 'monolog', 'datetime' => new \DateTimeImmutable(), 'extra' => []];
