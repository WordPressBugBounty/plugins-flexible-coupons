 ...
 */
namespace FlexibleCouponsVendor\Monolog\Handler\Slack;
...
class SlackRecord
{
     ...
     */
    public function __construct(?string $channel = null, ?string $username = null, bool $useAttachment = \true, ?string $userIcon = null, bool $useShortAttachment = \false, bool $includeContextAndExtra = \false, array $excludeFields = array(), ?\FlexibleCouponsVendor\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \FlexibleCouponsVendor\Monolog\Formatter\NormalizerFormatter();
        }
    }
    /**
    ...
    {
        switch (\true) {
            case $level >= \FlexibleCouponsVendor\Monolog\Logger::ERROR:
                return static::COLOR_DANGER;
            case $level >= \FlexibleCouponsVendor\Monolog\Logger::WARNING:
                return static::COLOR_WARNING;
            case $level >= \FlexibleCouponsVendor\Monolog\Logger::INFO:
    ...
    public function stringify(array $fields) : string
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \FlexibleCouponsVendor\Monolog\Utils::jsonEncode($normalized, \JSON_PRETTY_PRINT | \FlexibleCouponsVendor\Monolog\Utils::DEFAULT_JSON_FLAGS) : \FlexibleCouponsVendor\Monolog\Utils::jsonEncode($normalized, \FlexibleCouponsVendor\Monolog\Utils::DEFAULT_JSON_FLAGS);
    }
    /**
    ...
    public function setFormatter(?\FlexibleCouponsVendor\Monolog\Formatter\FormatterInterface $formatter = null) : self
    {
