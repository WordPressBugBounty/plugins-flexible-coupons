...
use FlexibleCouponsVendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use FlexibleCouponsVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
 ...
 */
class FingersCrossedHandler extends \FlexibleCouponsVendor\Monolog\Handler\Handler implements \FlexibleCouponsVendor\Monolog\Handler\ProcessableHandlerInterface, \FlexibleCouponsVendor\Monolog\ResettableInterface, \FlexibleCouponsVendor\Monolog\Handler\FormattableHandlerInterface
{
    ...
    public function __construct($handler, $activationStrategy = null, int $bufferSize = 0, bool $bubble = \true, bool $stopBuffering = \true, $passthruLevel = null)
    {
        if (null === $activationStrategy) {
            $activationStrategy = new \FlexibleCouponsVendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy(\FlexibleCouponsVendor\Monolog\Logger::WARNING);
        }
        // convert simple int activationStrategy to an object
        if (!$activationStrategy instanceof \FlexibleCouponsVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface) {
            $activationStrategy = new \FlexibleCouponsVendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy($activationStrategy);
        }
        ...
        if ($passthruLevel !== null) {
            $this->passthruLevel = \FlexibleCouponsVendor\Monolog\Logger::toMonologLevel($passthruLevel);
        }
        if (!$this->handler instanceof \FlexibleCouponsVendor\Monolog\Handler\HandlerInterface && !\is_callable($this->handler)) {
    ...
    public function reset()
    {
        ...
        if ($this->getHandler() instanceof \FlexibleCouponsVendor\Monolog\ResettableInterface) {
    ...
    {
        if (!$this->handler instanceof \FlexibleCouponsVendor\Monolog\Handler\HandlerInterface) {
