 ...
 */
class RotatingFileHandler extends \FlexibleCouponsVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \FlexibleCouponsVendor\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false)
    {
        $this->filename = \FlexibleCouponsVendor\Monolog\Utils::canonicalizePath($filename);
