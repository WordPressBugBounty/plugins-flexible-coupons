 ...
 */
abstract class AbstractHandler extends \FlexibleCouponsVendor\Monolog\Handler\Handler implements \FlexibleCouponsVendor\Monolog\ResettableInterface
{
    /**
     * @var int
     * @phpstan-var Level
     */
    protected $level = \FlexibleCouponsVendor\Monolog\Logger::DEBUG;
    /** @var bool */
