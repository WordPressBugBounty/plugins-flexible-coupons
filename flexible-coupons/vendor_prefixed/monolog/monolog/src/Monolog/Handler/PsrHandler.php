 ...
 */
class PsrHandler extends \FlexibleCouponsVendor\Monolog\Handler\AbstractHandler implements \FlexibleCouponsVendor\Monolog\Handler\FormattableHandlerInterface
{
    /**
     ...
     */
    public function __construct(\Psr\Log\LoggerInterface $logger, $level = \FlexibleCouponsVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
