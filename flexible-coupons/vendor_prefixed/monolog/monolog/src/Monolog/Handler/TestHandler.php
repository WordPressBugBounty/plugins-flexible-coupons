 ...
 */
class TestHandler extends \FlexibleCouponsVendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var Record[] */
    protected $records = [];
    ...
    {
        return isset($this->recordsByLevel[\FlexibleCouponsVendor\Monolog\Logger::toMonologLevel($level)]);
    }
    /**
    ...
    {
        $level = \FlexibleCouponsVendor\Monolog\Logger::toMonologLevel($level);
