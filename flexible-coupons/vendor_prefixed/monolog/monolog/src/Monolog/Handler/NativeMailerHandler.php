 ...
 */
class NativeMailerHandler extends \FlexibleCouponsVendor\Monolog\Handler\MailHandler
{
    /**
     ...
     */
    public function __construct($to, string $subject, string $from, $level = \FlexibleCouponsVendor\Monolog\Logger::ERROR, bool $bubble = \true, int $maxColumnWidth = 70)
    {
    ...
    protected function send(string $content, array $records) : void
    {
        ...
        if ($records) {
            $subjectFormatter = new \FlexibleCouponsVendor\Monolog\Formatter\LineFormatter($this->subject);
