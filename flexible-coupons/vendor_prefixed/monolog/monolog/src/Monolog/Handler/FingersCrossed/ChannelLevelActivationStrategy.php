 ...
 */
class ChannelLevelActivationStrategy implements \FlexibleCouponsVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface
{
    /**
     * @var Level
     */
    ...
    {
        $this->defaultActionLevel = \FlexibleCouponsVendor\Monolog\Logger::toMonologLevel($defaultActionLevel);
