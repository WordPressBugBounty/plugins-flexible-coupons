 ...
 */
class OverflowHandler extends \FlexibleCouponsVendor\Monolog\Handler\AbstractHandler implements \FlexibleCouponsVendor\Monolog\Handler\FormattableHandlerInterface
{
    /** @var HandlerInterface */
    private $handler;
    /** @var int[] */
    private $thresholdMap = [\FlexibleCouponsVendor\Monolog\Logger::DEBUG => 0, \FlexibleCouponsVendor\Monolog\Logger::INFO => 0, \FlexibleCouponsVendor\Monolog\Logger::NOTICE => 0, \FlexibleCouponsVendor\Monolog\Logger::WARNING => 0, \FlexibleCouponsVendor\Monolog\Logger::ERROR => 0, \FlexibleCouponsVendor\Monolog\Logger::CRITICAL => 0, \FlexibleCouponsVendor\Monolog\Logger::ALERT => 0, \FlexibleCouponsVendor\Monolog\Logger::EMERGENCY => 0];
    /**
     ...
     */
    public function __construct(\FlexibleCouponsVendor\Monolog\Handler\HandlerInterface $handler, array $thresholdMap = [], $level = \FlexibleCouponsVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
