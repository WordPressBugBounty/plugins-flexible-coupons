...
class Registry
{
     ...
     * @return void
     */
    public static function addLogger(\FlexibleCouponsVendor\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
    ...
    {
        if ($logger instanceof \FlexibleCouponsVendor\Monolog\Logger) {
     ...
     */
    public static function getInstance($name) : \FlexibleCouponsVendor\Monolog\Logger
    {
