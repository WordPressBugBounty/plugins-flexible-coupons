 ...
 */
class MongoDBFormatter implements \FlexibleCouponsVendor\Monolog\Formatter\FormatterInterface
{
    /** @var bool */
    ...
    protected function formatObject($value, int $nestingLevel)
    {
        ...
        $objectVars['class'] = \FlexibleCouponsVendor\Monolog\Utils::getClass($value);
    ...
    {
        $formattedException = ['class' => \FlexibleCouponsVendor\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => (int) $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine()];
