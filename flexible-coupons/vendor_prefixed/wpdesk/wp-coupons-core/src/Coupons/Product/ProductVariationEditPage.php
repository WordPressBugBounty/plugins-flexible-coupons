 ...
 */
namespace FlexibleCouponsVendor\WPDesk\Library\WPCoupons\Product;
 ...
 */
class ProductVariationEditPage implements \FlexibleCouponsVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function add_product_general_data_field($loop, $variation_data, $variation)
    {
        ...
        $this->renderer->output_render('variation/html-variation-select', ['post_id' => $variation->ID, 'loop' => $loop, 'is_premium' => $this->product_fields->is_premium(), 'custom_attributes' => $this->get_field_attributes(), 'pro_url' => \FlexibleCouponsVendor\WPDesk\Library\WPCoupons\Helpers\Links::get_pro_link()]);
