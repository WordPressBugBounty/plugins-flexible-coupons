...
?>
<div><strong><?php 
\esc_html_e('Coupon code:', 'flexible-coupons');
?></strong> <a class="<?php 
...
\esc_attr_e('View PDF', 'flexible-coupons');
?>"><?php 
\esc_html_e('View', 'flexible-coupons');
?></a>
<a class="download_coupon button button-secondary" href="<?php 
echo \esc_url($download_url);
?>" target="_blank" title="<?php 
\esc_attr_e('Download PDF coupon', 'flexible-coupons');
?>"><?php 
\esc_html_e('Download', 'flexible-coupons');
?></a>
<?php 
