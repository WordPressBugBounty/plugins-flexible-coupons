...
$value = $meta->get_private($post_id, 'flexible_coupon_disable_pdf', 'no');
\woocommerce_wp_checkbox(['id' => "fc_disable_pdf{$loop_id}", 'name' => "fc_disable_pdf{$loop_name}", 'value' => $value, 'label' => \esc_html__('Disable the PDF coupon for this variation', 'flexible-coupons'), 'desc_tip' => \true, 'description' => '', 'wrapper_class' => '', 'class' => 'fc_disable_pdf_coupon', 'custom_attributes' => $custom_attributes]);
