...
final class Tracker
{
    ...
    private function register_hooks()
    {
        ...
        add_action('admin_init', [\FlexibleCouponsVendor\WPDesk_Tracker::class, 'schedule']);
    ...
    public function send_scheduled_tracking_data()
    {
        ...
        if ($tracker instanceof \FlexibleCouponsVendor\WPDesk_Tracker) {
    ...
    private function get_tracker()
    {
        ...
        if (!is_object($tracker)) {
            $factory = new \FlexibleCouponsVendor\WPDesk_Tracker_Factory_Prefixed($this->logger);
