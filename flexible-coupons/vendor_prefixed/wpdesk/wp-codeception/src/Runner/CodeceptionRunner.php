...
final class CodeceptionRunner
{
    ...
    {
        try {
            return class_exists(\FlexibleCouponsVendor\Codeception\Command\Run::class) && (new \FlexibleCouponsVendor\Codeception\Command\Run())->getDefinition()->hasOption('shard');
        } catch (\Throwable) {
            return \false;
        }
    }
