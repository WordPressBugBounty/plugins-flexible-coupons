...
use FlexibleCouponsVendor\Composer\Plugin\Capability\CommandProvider as CommandProviderCapability;
use FlexibleCouponsVendor\WPDesk\Codeception\Composer\Command\LegacyCommand;
