 ...
 */
class RunCodeceptionTests extends \FlexibleCouponsVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    const SINGLE = 'single';
    const FAST = 'fast';
    ...
    {
        parent::configure();
        $this->setName('run-codeception-tests')->setDescription('Run codeception tests.')->setDefinition(array(new \FlexibleCouponsVendor\Symfony\Component\Console\Input\InputArgument(self::SINGLE, \FlexibleCouponsVendor\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Name of Single test to run.', 'all'), new \FlexibleCouponsVendor\Symfony\Component\Console\Input\InputArgument(self::FAST, \FlexibleCouponsVendor\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Fast tests - do not shutdown docker-compose.', 'slow'), new \FlexibleCouponsVendor\Symfony\Component\Console\Input\InputArgument(self::WOOCOMMERCE_VERSION, \FlexibleCouponsVendor\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'WooCommerce version to install.', '')));
    }
    /**
     * Execute command.
     *
