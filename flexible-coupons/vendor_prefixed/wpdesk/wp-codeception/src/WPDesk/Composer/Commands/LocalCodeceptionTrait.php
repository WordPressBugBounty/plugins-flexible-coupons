...
trait LocalCodeceptionTrait
{
    ...
    {
        try {
            $wpdesk_configuration = \FlexibleCouponsVendor\Symfony\Component\Yaml\Yaml::parseFile(\getcwd() . '/tests/codeception/wpdesk.yml');
        } catch (\FlexibleCouponsVendor\Symfony\Component\Yaml\Exception\ParseException $e) {
            $wpdesk_configuration = array();
        }
        return \FlexibleCouponsVendor\WPDesk\Composer\Codeception\Commands\Configuration::createFromEnvAndConfiguration($wpdesk_configuration);
    }
    /**
     * @param OutputInterface $output
     * @param Configuration   $configuration
     */
    private function prepareWpConfig(\FlexibleCouponsVendor\Symfony\Component\Console\Output\OutputInterface $output, \FlexibleCouponsVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @param Configuration   $configuration
     */
    private function activatePlugins(\FlexibleCouponsVendor\Symfony\Component\Console\Output\OutputInterface $output, \FlexibleCouponsVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     */
    private function executeWpCliAndOutput($command, \FlexibleCouponsVendor\Symfony\Component\Console\Output\OutputInterface $output, $apache_document_root)
    {
     ...
     * @param bool            $coverage
     */
    private function installPlugin(string $plugin_dir, \FlexibleCouponsVendor\Symfony\Component\Console\Output\OutputInterface $output, \FlexibleCouponsVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration, bool $coverage = \true)
    {
     ...
     * @return string
     */
    private function prepareTargetDir($plugin_slug, \FlexibleCouponsVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @param OutputInterface $output
     */
    private function prepareCommonWpWcConfiguration(\FlexibleCouponsVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration, \FlexibleCouponsVendor\Symfony\Component\Console\Output\OutputInterface $output)
    {
     ...
     */
    private function prepareLocalCodeceptionTests(\FlexibleCouponsVendor\Symfony\Component\Console\Input\InputInterface $input, \FlexibleCouponsVendor\Symfony\Component\Console\Output\OutputInterface $output, bool $coverage = \false)
    {
