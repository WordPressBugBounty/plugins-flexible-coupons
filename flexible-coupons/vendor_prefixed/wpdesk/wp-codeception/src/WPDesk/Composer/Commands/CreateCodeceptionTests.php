 ...
 */
class CreateCodeceptionTests extends \FlexibleCouponsVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    use SedTrait;
    /**
     * Configure command.
    ...
    {
        if (!\copy($source, $dest)) {
            throw new \FlexibleCouponsVendor\Composer\Downloader\FilesystemException($exceptionMessage);
        }
    }
    /**
