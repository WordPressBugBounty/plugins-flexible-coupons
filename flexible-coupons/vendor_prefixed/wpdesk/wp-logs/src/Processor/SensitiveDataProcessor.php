...
namespace FlexibleCouponsVendor\WPDesk\Logger\Processor;
 ...
 */
class SensitiveDataProcessor implements \FlexibleCouponsVendor\Monolog\Processor\ProcessorInterface
{
    /**
     * Replace array.
     *
