...
namespace FlexibleCouponsVendor\WPDesk\Logger\WP;
...
class WPCapture
{
    ...
    {
        new \FlexibleCouponsVendor\WPDesk\Notice\Notice(\sprintf(
            // Translators: directory.
            \__('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'flexible-coupons'),
            $dir
        ), \FlexibleCouponsVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
     * Add notice for file.
     *
    ...
    private function add_notice_for_file($file)
    {
        new \FlexibleCouponsVendor\WPDesk\Notice\Notice(\sprintf(
            // Translators: directory.
            \__('Can not enable WP Desk Debug log! Cannot create file %s!', 'flexible-coupons'),
            $file
        ), \FlexibleCouponsVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
