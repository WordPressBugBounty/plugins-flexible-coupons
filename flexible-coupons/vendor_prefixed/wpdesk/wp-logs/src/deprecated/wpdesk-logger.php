...
if (!\class_exists('FlexibleCouponsVendor\WPDesk_Logger')) {
    ...
    class WPDesk_Logger
    {
        ...
        {
            if (!self::$logger) {
                $loggerFactroy = new \FlexibleCouponsVendor\WPDesk\Logger\WPDeskLoggerFactory();
        ...
        {
            return ['disabled' => \__('Disabled', 'flexible-coupons'), 'emergency' => \__('Emergency', 'flexible-coupons'), 'alert' => \__('Alert', 'flexible-coupons'), 'critical' => \__('Critical', 'flexible-coupons'), 'error' => \__('Error', 'flexible-coupons'), 'warning' => \__('Warning', 'flexible-coupons'), 'notice' => \__('Notice', 'flexible-coupons'), 'info' => \__('Info', 'flexible-coupons'), 'debug' => \__('Debug', 'flexible-coupons')];
        }
        /**
         * @param string $level
         * @param string $source
