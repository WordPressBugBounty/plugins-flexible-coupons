...
?>">
			<?php 
\esc_html_e('Set image', 'flexible-coupons');
?>
		</a>
...
?>" href="#">
			<?php 
\esc_html_e('Remove image', 'flexible-coupons');
?>
		</a>
	</p>
</div>
...
?>' ),
		...
		addImgLink.on( 'click', function ( event ) {
			...
			frame = wp.media( {
				title: "<?php 
\esc_html_e('Select or Upload Media', 'flexible-coupons');
?>",
				button: {
					text: "<?php 
\esc_html_e('Use this media', 'flexible-coupons');
?>"
				},
				library: {
					type: ['image']
