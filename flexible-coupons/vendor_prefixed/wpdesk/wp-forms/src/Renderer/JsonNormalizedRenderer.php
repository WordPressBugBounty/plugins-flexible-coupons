...
namespace FlexibleCouponsVendor\WPDesk\Forms\Renderer;

use FlexibleCouponsVendor\WPDesk\Forms\FieldProvider;
use FlexibleCouponsVendor\WPDesk\Forms\FieldRenderer;
/**
 * Can render form fields as JSON.
 *
 * @package WPDesk\Forms\Renderer
 */
class JsonNormalizedRenderer implements \FlexibleCouponsVendor\WPDesk\Forms\FieldRenderer
{
    /**
     ...
     */
    public function render_fields(\FlexibleCouponsVendor\WPDesk\Forms\FieldProvider $provider, array $fields_data, $name_prefix = '')
    {
        $rendered_fields = [];
