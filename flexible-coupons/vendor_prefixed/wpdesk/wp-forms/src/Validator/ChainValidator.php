...
class ChainValidator implements \FlexibleCouponsVendor\WPDesk\Forms\Validator
{
    /** @var Validator[] */
    private $validators;
    private $messages;
     ...
     * @return $this
     */
    public function attach(\FlexibleCouponsVendor\WPDesk\Forms\Validator $validator)
    {
