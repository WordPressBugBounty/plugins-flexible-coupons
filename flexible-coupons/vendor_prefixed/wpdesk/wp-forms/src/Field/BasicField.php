...
use FlexibleCouponsVendor\WPDesk\Forms\Sanitizer\NoSanitize;
use FlexibleCouponsVendor\WPDesk\Forms\Serializer;
use FlexibleCouponsVendor\WPDesk\Forms\Serializer\NoSerialize;
use FlexibleCouponsVendor\WPDesk\Forms\Validator\ChainValidator;
use FlexibleCouponsVendor\WPDesk\Forms\Validator\RequiredValidator;
/**
 ...
 */
abstract class BasicField implements \FlexibleCouponsVendor\WPDesk\Forms\Field
{
    ...
    {
        $chain = new \FlexibleCouponsVendor\WPDesk\Forms\Validator\ChainValidator();
        if ($this->is_required()) {
            $chain->attach(new \FlexibleCouponsVendor\WPDesk\Forms\Validator\RequiredValidator());
        }
        return $chain;
    }
    ...
    {
        return new \FlexibleCouponsVendor\WPDesk\Forms\Sanitizer\NoSanitize();
    }
    /**
     * @return Serializer
     */
    ...
    {
        if (isset($this->meta['serializer']) && $this->meta['serializer'] instanceof \FlexibleCouponsVendor\WPDesk\Forms\Serializer) {
            return $this->meta['serializer'];
        }
        return new \FlexibleCouponsVendor\WPDesk\Forms\Serializer\NoSerialize();
    }
    public function set_serializer(\FlexibleCouponsVendor\WPDesk\Forms\Serializer $serializer)
    {
