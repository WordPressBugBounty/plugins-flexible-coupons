...
namespace FlexibleCouponsVendor\WPDesk\Persistence\Adapter\WordPress;
 ...
 */
final class WordpressPostMetaContainer implements \FlexibleCouponsVendor\WPDesk\Persistence\PersistentContainer
{
    ...
    public function get($key)
    {
        ...
        if (\count($meta) === 0) {
            throw new \FlexibleCouponsVendor\WPDesk\Persistence\ElementNotExistsException(\sprintf('Element %s not exists!', $key));
        }
        return $meta[0];
    }
    /**
