...
namespace FlexibleCouponsVendor\WPDesk\Persistence\Decorator;
...
use FlexibleCouponsVendor\WPDesk\Persistence\AllDataAccessContainer;
/**
 * You can use this class to delay write access to any PersistenceContainer and save it as single value.
 *
 * @package WPDesk\Persistence
 */
final class DelaySinglePersistentContainer extends \FlexibleCouponsVendor\WPDesk\Persistence\Decorator\DelayPersistentContainer implements \FlexibleCouponsVendor\WPDesk\Persistence\AllDataAccessContainer
{
    /**
     ...
     */
    private $key;
    public function __construct(\FlexibleCouponsVendor\WPDesk\Persistence\PersistentContainer $container, string $key)
    {
