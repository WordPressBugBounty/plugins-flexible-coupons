...
use FlexibleCouponsVendor\WPDesk\Persistence\DeferredPersistentContainer;
 ...
 */
class DelayPersistentContainer implements \FlexibleCouponsVendor\WPDesk\Persistence\DeferredPersistentContainer
{
     ...
     */
    protected $changed = [];
    public function __construct(\FlexibleCouponsVendor\WPDesk\Persistence\PersistentContainer $container)
    {
