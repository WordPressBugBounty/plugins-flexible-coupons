 ...
 */
class SimplePhpRenderer implements \FlexibleCouponsVendor\WPDesk\View\Renderer\Renderer
{
    /** @var Resolver */
    private $resolver;
    public function __construct(\FlexibleCouponsVendor\WPDesk\View\Resolver\Resolver $resolver)
    {
