...
if (!\interface_exists('FlexibleCouponsVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('FlexibleCouponsVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('FlexibleCouponsVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \FlexibleCouponsVendor\WPDesk_Translatable, \FlexibleCouponsVendor\WPDesk_Buildable, \FlexibleCouponsVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
