 ...
 */
class InfoBuilder extends \FlexibleCouponsVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function __construct(\FlexibleCouponsVendor\WPDesk_Buildable $info)
    {
        $this->info = $info;
