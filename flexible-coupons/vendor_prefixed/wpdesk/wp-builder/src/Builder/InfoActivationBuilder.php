...
namespace FlexibleCouponsVendor\WPDesk\PluginBuilder\Builder;
...
use FlexibleCouponsVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
 ...
 */
class InfoActivationBuilder extends \FlexibleCouponsVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
     ...
     */
    public function __construct(\FlexibleCouponsVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \FlexibleCouponsVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\FlexibleCouponsVendor\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
